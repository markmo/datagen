...
function set_customer_attribute(customer_key, attr_name::String, attr_value)
    hset(string("customer:", customer_key), attr_name, attr_value)
end

function set_customer_attributes(customer_key, attrs::Array)
    hmset(string("customer:", customer_key), attrs)
end

function get_customer_attribute(customer_key, attr_name::String)
    hget(string("customer:", customer_key), attr_name)
end

function get_customer_attribute_selection(customer_key, fields::Array)
...
function set_customer_since_date(customer_key, since_date::String)
    set_customer_attribute(customer_key, "since_date", since_date)
end

function get_customer_since_date(customer_key)
...
function set_account_attribute(account_key, attr_name::String, attr_value)
    hset(string("account:", account_key), attr_name, attr_value)
end

function set_account_attributes(account_key, attrs::Array)
    hmset(string("account:", account_key), attrs)
end

function get_account_attribute(account_key, attr_name::String)
    hget(string("account:", account_key), attr_name)
end

function get_account_attribute_selection(account_key, fields::Array)
    hmget(string("account:", account_key), fields)
end

function get_account_attributes(account_key)
    hgetall(string("account:", account_key))
end

function set_account_open_date(account_key, open_date::String)
    set_account_attribute(account_key, "open_date", open_date)
end

function get_account_open_date(account_key)
...
function get_account_type(account_key)
    get_account_attribute(account_key, "account_type")
end

function get_customer_accounts(customer_key)
    account_keys = get_customer_account_keys(customer_key)
    account_types = []
    open_dates = []
    for account_key in account_keys
